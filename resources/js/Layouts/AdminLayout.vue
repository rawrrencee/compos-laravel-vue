...
const adminNavigation = [
  ...
  },
  {
    ...
    href: 'infrastructure',
    children: [
      { name: 'Companies', href: 'infrastructure.companies.viewLandingPage' },
      { name: 'Stores', href: 'infrastructure.stores.viewLandingPage' },
      { name: 'Suppliers', href: 'infrastructure.suppliers.viewLandingPage' },
    ],
  },
  {
    name: 'Commerce',
...
const isDesktopNarrowSidebarShown = ref(
  sessionStorage.getItem('isDesktopNarrowSidebarShown') === 'false' ? false : true
);
...
watch(isDesktopNarrowSidebarShown, (isDesktopNarrowSidebarShown) => {
  sessionStorage.setItem('isDesktopNarrowSidebarShown', isDesktopNarrowSidebarShown);
});
// #endregion Watch
</script>
...
<template>
  <div class="flex h-full flex-col">
        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <AdminSidebar :employee-navigation="employeeNavigation" :admin-navigation="adminNavigation" />
            </DialogPanel>
          </TransitionChild>
        </div>
      </Dialog>
    ...
    >
      ...
      />
      <AdminNarrowSidebar :employee-navigation="employeeNavigation" :admin-navigation="adminNavigation" v-else />
    </Transition>
    ...
    >
      <AdminStickyTopBar
        v-model:is-desktop-narrow-sidebar-shown="isDesktopNarrowSidebarShown"
