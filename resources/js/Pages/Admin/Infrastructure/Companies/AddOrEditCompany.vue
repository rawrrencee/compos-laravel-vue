    ...
    <form class="px-4 pt-4 sm:px-0 flex flex-col h-full" @submit.prevent="submit">
      <div class="flex-1 grow grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 pb-12">
        <div class="sm:col-span-4">
          ...
          <div class="mt-2 flex flex-col gap-1">
            <input
              ...
              :class="companyForm.errors.company_name ? 'border-error' : ''"
              @input="() => companyForm.clearErrors('company_name')"
            />
            <span v-if="companyForm.errors.company_name" class="text-error">
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 max-w-lg">
        ...
        <div class="sm:col-span-4">
          <label for="address_1" class="block text-sm font-medium leading-6 text-gray-900">Address Line 1</label>
          <div class="mt-2">
            <input
              id="address_1"
              type="text"
        ...
        <div class="sm:col-span-4">
          <label for="address_2" class="block text-sm font-medium leading-6 text-gray-900">Address Line 2</label>
          <div class="mt-2">
            <input
              id="address_2"
              type="text"
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2 flex flex-col gap-1">
            <input
              ...
              :class="companyForm.errors.email ? 'border-error' : ''"
              @input="() => companyForm.clearErrors('email')"
            />
            <span v-if="companyForm.errors.email" class="text-error">
        ...
        <div class="sm:col-span-4">
          <label for="img_url" class="block text-sm font-medium leading-6 text-gray-900">Image URL</label>
          <div class="mt-2">
            <input
              id="img_url"
              type="text"
